...
Detailed step-by-step procedure for generating an executable phase plan.

**Parent:** [../SKILL.md](../SKILL.md) > Subcommand: phase
...
Spawn opti-gsd-plan-checker agent. See [../reference/plan-validation.md](../reference/plan-validation.md) for full validation rules.
...
Create `.opti-gsd/plans/phase-{N}/plan.json`. See [../reference/task-format.md](../reference/task-format.md) for the full XML task structure and field definitions.
...
{XML task elements — see reference/task-format.md}

## Wave 2 (After Wave 1)

{XML task elements with depends attributes}
```
