...
- `/opti-gsd:codebase` — Analyze codebase structure
- `/opti-gsd:codebase --debt` — Scan for technical debt markers
- `/opti-gsd:codebase --refresh` — Force re-scan of codebase
...
- Force re-scan: /opti-gsd:codebase --refresh
...
→ /opti-gsd:init new    — Or start fresh
